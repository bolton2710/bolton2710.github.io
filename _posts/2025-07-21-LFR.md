...
(This problem is adapted from Folger-Elements of Chemical Reaction Engineering 6th Ed, example 18-4)
...
Although Fogler's and the COMSOL solution are at steady-state, we set up this as a non-steady-state problem for the extra challenge.
